...
<body class="min-h-screen bg-gray-900 mt-20">
    ...
    <div class="mx-auto max-w-xl text-center">
        ...
        <p class="mt-6 text-lg font-medium text-pretty text-gray-400 sm:text-xl">
            SmilePro is dé specialist in tandheelkundige zorg en esthetiek. Log in om onze innovatieve behandelingen te
            bekijken en direct een afspraak te maken voor een stralende glimlach!
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col items-center">
                <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=600&q=80"
                    alt="Professionele zorg" class="mb-4 rounded-lg h-40 w-full object-cover">
                <h3 class="text-xl font-semibold text-white mb-2">Professionele zorg</h3>
                <p class="text-gray-400 text-center">Ons team bestaat uit ervaren tandartsen en mondhygiënisten die
                    werken met de nieuwste technieken voor optimale mondgezondheid.</p>
            </div>
            <!-- Infokaart 2 -->
            <div class="bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col items-center">
                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=600&q=80"
                    alt="Esthetische behandelingen" class="mb-4 rounded-lg h-40 w-full object-cover">
                <h3 class="text-xl font-semibold text-white mb-2">Esthetische behandelingen</h3>
                <p class="text-gray-400 text-center">Van tanden bleken tot facings: SmilePro biedt diverse cosmetische
                    behandelingen voor een zelfverzekerde lach. Log in om alle mogelijkheden te ontdekken!</p>
            </div>
            <!-- Infokaart 3 -->
            <div class="bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col items-center">
                ...
                <p class="text-gray-400 text-center">Wij luisteren naar jouw wensen en stellen samen een behandelplan op
                    dat bij jou past. Log in en ervaar onze persoonlijke service!</p>
            </div>
        </div>
    </div>
