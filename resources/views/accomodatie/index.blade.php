            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" id="filterMinPrice" placeholder="0" min="0">
                    </div>
                </div>
                    ...
                    <div class="card h-100 shadow-sm">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text text-muted mb-3">
                                {{ $accommodatie->Postcode }} {{ $accommodatie->Stad }}, {{ $accommodatie->Land }}
                            </p>

                            <hr class="my-2">

                            <div class="mb-3">
                                <p class="card-text mb-2"><strong>Kamers:</strong> {{ $accommodatie->AantalKamers }}
                                </p>
