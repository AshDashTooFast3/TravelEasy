...
use App\Http\Controllers\NumberGuessController;
...
Route::get('/numbergame', [NumberGuessController::class, 'index'])->name('numbergame.index');
Route::post('/numbergame', [NumberGuessController::class, 'guess'])->name('numbergame.guess');
